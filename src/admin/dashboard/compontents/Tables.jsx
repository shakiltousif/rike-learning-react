...
export default function Tables({ data }) {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div className="relative shadow-md sm:rounded-lg text-white bg-opacity-10 backdrop-blur-lg rounded drop-shadow-lg bg-white p-5 overflow-y-auto">
        <div>
      ...
      <div className="text-white">
        <div className="w-full h-auto rounded p-5 bg-opacity-10 backdrop-blur-lg rounded drop-shadow-lg bg-white mb-5">
        ...
        <div className="w-full h-auto rounded p-5 bg-opacity-10 backdrop-blur-lg rounded drop-shadow-lg bg-white">
          <h1 className="mb-5 text-xl font-bold lg:text-2xl">Withdraws</h1>
