...
const Sidebar = ({ context }) => {
  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 bg-opacity-10 backdrop-blur-lg rounded drop-shadow-lg bg-white dark:border-gray-700">
      ...
      <aside
        ...
        id="logo-sidebar"
        className={`fixed top-0 left-0 z-40 w-64 h-screen pt-16 bg-opacity-10 backdrop-blur-lg rounded drop-shadow-lg bg-white transition-transform ${
          IsMainNavShow ? "" : "-translate-x-full"
        }  sm:translate-x-0`}
        aria-label="Sidebar"
      >
        <div className="h-full rounded-r-[15%] overflow-y-auto px-3 py-4 text-white bg-opacity-10 backdrop-blur-lg rounded drop-shadow-lg bg-white">
