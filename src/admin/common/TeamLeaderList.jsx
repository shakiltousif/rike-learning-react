    ...
    content = team_leaders?.data?.data?.map((team_leader, key) => (
      ...
      >
        ...
        <td
          ...
          className="text-black dark:text-white block md:table-cell text-end md:text-start md:before:content-[''] before:content-[attr(data-label)] before:float-left before:font-bold font-medium text-gray-900 whitespace-nowrap px-6 py-4"
        >
          {parseInt(team_leader?.total_student)}
        </td>
        <td
          data-label="Date"
          className="text-black dark:text-white block md:table-cell text-end md:text-start md:before:content-[''] before:content-[attr(data-label)] before:float-left before:font-bold font-medium text-gray-900 whitespace-nowrap px-6 py-4"
        ...
        <td data-label={"Action"} className="px-6 py-4">
          <div className="flex items-center justify-end gap-2">
            <Link
              to={`/admin/team_leader/${team_leader?.id}`}
            ...
            <DeleteModal
              ...
              mutationFn={deleteTeamLeaderUser}
              deleteId={team_leader?.id}
              refetchFn={refetch}
            />
          </div>
        </td>
            ...
            <div className="my-4">
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  className="block p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg w-80 bg-opacity-10 backdrop-blur-lg rounded drop-shadow-lg bg-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
