...
import {
  getSingleCounsellor,
  postSingleCounsellorBalanceUpdate,
  postSingleCounsellorUser,
...
const SingleCounsellor = () => {
  ...
  return (
    <>
      <Breadcrumb title="Single Counsellor" />
          ...
          {!isLoading && (
            <div className="my-4 flex justify-end">
              {userCan("manage_user_balance") && (
                <UpdateBalanceModal
                  mutationFn={postSingleCounsellorBalanceUpdate}
                  Id={userId}
                  refetchFn={refetch}
