    ...
    const handleSubmit = async (e) => {
        ...
        if (formValid) {
            try {
                ...
                const response = await axios.post('https://api.usrike-learning.com/public/api/admin/term-conditions', formData,
                {
                    headers: {
    ...
    useEffect(() => {
        ...
        if(token){
            const fetchData = async () => {
                try {
                    const response = await axios.get('https://api.usrike-learning.com/public/api/admin/term-conditions',
                    {
                      headers: {
                        Authorization: 'Bearer ' + token
                      }
