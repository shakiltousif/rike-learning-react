...
import SeniorTeamLeaderMap from "../../components/admin/common/SeniorTeamLeaderMapModal.jsx";
  ...
  return (
    <>
      ...
      <div className="my-12 p-6">
        {!isLoading && user?.roles?.[0]?.name == "Counsellor" && (
          // !user?.senior_counsellor_id &&
          <SeniorCounsellorMapModal />
        )}
        {!isLoading && user?.roles?.[0]?.name == "Team Leader" && (
          //  !user?.senior_team_leader_uid &&
          <SeniorTeamLeaderMap />
        )}
