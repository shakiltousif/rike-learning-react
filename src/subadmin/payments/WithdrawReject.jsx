...
import { getAdminRejectedWithdrawals } from "../../hooks/admin/withdrawApi";
...
const WithdrawComplete = () => {
  ...
  const {
    ...
    isError,
    error,
  } = useQuery("getAdminRejectedWithdrawals", () =>
    getAdminRejectedWithdrawals({ count })
  );
  ...
  return (
    <>
      <Breadcrumb title="Withdrawal Rejected" />
