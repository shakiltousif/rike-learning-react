...
function Breadcrumb(props) {
  return (
    <div className="flex items-center flex-col lg:flex-row justify-between bg-opacity-10 backdrop-blur-lg rounded drop-shadow-lg bg-white text-white p-5 shadow-md sm:rounded-lg">
      <div>
