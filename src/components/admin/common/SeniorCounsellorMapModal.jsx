...
import { postChangeSeniorCounsellor } from "../../../hooks/admin/adminCommonApi";

export default function SeniorCounsellorMapModal() {
  const [id_number, setCounsellorId] = useState("");
  const [opened, { open, close }] = useDisclosure(false);

  const { isLoading, mutate } = useMutation(postChangeSeniorCounsellor, {
    onSuccess: (response) => {
      ...
      >
        <div className="my-10">
          <div className="relative z-0 w-full mb-6 group">
            <input
              type="number"
              name="floating_counsellor_id"
              id="floating_counsellor_id"
