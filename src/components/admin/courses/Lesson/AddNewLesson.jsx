...
import { postSingleCourseLessonCreate } from "../../../../hooks/admin/courseApi";

export default function AddNewLesson({ courseId, refetchFn }) {
  const [short_description, setShortDescription] = useState("");
  const [name, setName] = useState("");
  const [opened, { open, close }] = useDisclosure(false);

  const { isLoading, mutate } = useMutation(postSingleCourseLessonCreate, {
    onSuccess: () => {
      close();
      refetchFn();
