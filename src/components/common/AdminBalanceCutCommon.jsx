...
import { postAdminBalanceCutCommon } from "../../hooks/common/common";

export default function AdminBalanceCutCommon() {
  const { isLoading, mutate } = useMutation(postAdminBalanceCutCommon, {
    onSuccess: (response) => {
