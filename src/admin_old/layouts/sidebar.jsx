...
const Sidebar = ({ context }) => {
  ...
  return (
    <>
      <nav className="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-[#070c44] dark:border-gray-700">
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="nav-menu-section h-full rounded-r-[15%] overflow-y-auto px-3 py-4 text-white">
