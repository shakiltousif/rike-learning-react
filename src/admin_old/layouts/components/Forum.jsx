        ...
        <>
            <li>
                <button onClick={handleDropdownToggle} type="button" className="flex items-center p-2 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">
                    ...
                    <span className="flex-1 ml-3 text-left whitespace-nowrap">Manage Forum</span>
                ...
                <ul className="py-2 space-y-2">
                    <li>
                    <NavLink onClick={toggleMainNav} to="#" className="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Forum Category</NavLink>
                    </li>
                </ul>
                )}
            </li>
