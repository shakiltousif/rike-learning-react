...
import {
  getSingleTeamLeaderUser,
  postSingleTeamLeaderBalanceUpdate,
  postSingleTeamLeaderUser,
} from "../../hooks/admin/adminCommonApi.js";
...
const SingleUser = () => {
  ...
  const { isLoading, refetch } = useQuery(
    "getSingleTeamLeaderUser",
    () => getSingleTeamLeaderUser(userId),
    {
      onSuccess: (response) => {
  ...
  return (
    <>
      <Breadcrumb title="Single Team Leader" />
          ...
          {!isLoading && (
            <div className="my-4 flex justify-end">
              {userCan("manage_user_balance") && (
                <UpdateBalanceModal
                  mutationFn={postSingleTeamLeaderBalanceUpdate}
                  Id={userId}
                  refetchFn={refetch}
