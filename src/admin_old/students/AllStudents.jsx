...
// import SendNoticeToStudentModal from "../../components/admin/student/SendNoticeToStudentModal.jsx";
...
const AllStudents = () => {
  ...
  if (!isLoading && students?.data?.data?.length > 0)
    content = students?.data?.data?.map((student, key) => (
      <tr key={key} className="section-bg border-b dark:text-white">
    ...
    <>
      ...
      <div className="container mx-auto my-5 p-5">
        <div className="flex justify-between">
          ...
          <div>
            {/* {!isLoading && userRoleCan("Super Admin") && (
              <SendNoticeToStudentModal buttonText={"Send Notice"} />
            )} */}
          </div>
        </div>
